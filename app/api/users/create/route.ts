    ...
    if (sendInvitation) {
      ...
      try {
        ...
        const invitation = await clerkClient.invitations.createInvitation({
          ...
          redirectUrl: process.env.NEXT_PUBLIC_CLERK_AFTER_SIGN_UP_URL || '/sign-up', // Corrected redirect URL
        })
        ...
        try {
          ...
          try {
              ...
              `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/api/send-email`,
              {
                ...
                body: JSON.stringify({
                  ...
                  data: {
                    ...
                    lastName,
                    tempPassword,
                    resetPasswordUrl: `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/sign-in`,
            ...
            if (emailResponse.ok) {
              ...
              console.error('Temporary password email failed:', await emailResponse.text())
            }
          } catch (emailError) {
