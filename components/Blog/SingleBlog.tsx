...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg bg-card text-card-foreground shadow-md transition duration-300 hover:shadow-lg">
      ...
      <div className="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-8 2xl:p-8">
        ...
        <div className="flex items-center">
          ...
          <div>
            <h4 className="mb-1 text-sm font-medium text-foreground">Date</h4>
